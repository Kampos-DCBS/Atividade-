...
describe('Validação da Página de Login', () => {
  ...
  const LOGIN_URL = 'http://127.0.0.1:3000/Atv4.html' // Altere para a URL real da sua aplicação
  ...
  it('Deve verificar a presença e o estado inicial dos campos do formulário', () => {
    ...
    // 4. nome completo no footer
    cy.get('footer')
    .should('contain', 'Daniel Campos Borges Santiago')
  })
});

it('teste', function() {
  cy.visit('http://127.0.0.1:3000/Atv4.html')
